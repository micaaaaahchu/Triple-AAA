package CustomerAAAPortlet.portlet;

import CustomerAAAPortlet.constants.CustomerAAAPortletKeys;
import CustomerAAAServices.model.Customer;
import CustomerAAAServices.model.Services;
import CustomerAAAServices.service.CustomerLocalService;
import CustomerAAAServices.service.CustomerLocalServiceUtil;
import CustomerAAAServices.service.ServicesLocalService;
import CustomerAAAServices.service.ServicesLocalServiceUtil;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=CustomerAAA",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + CustomerAAAPortletKeys.CUSTOMERAAA,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class CustomerAAAPortlet extends MVCPortlet {
	//CustomerPortlet
    ...
    private static Log _log = LogFactoryUtil.getLog(CustomerAAAPortlet.class);
